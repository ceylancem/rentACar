...
public class RentACarApplication {
	...
	@Bean // Bu anotasyon konulduğu zaman spring bunu görür ve sonrasında böyle bir
			// nesneye ihtiyaç duyulacağını anlayarak bu nesneden bir instance new'ler ve
			// kullanılmak üzere saklar.
